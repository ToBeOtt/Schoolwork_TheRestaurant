...
public static class ProductSeeds
{
    public static void SeedProducts(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { Id = 18, Name = "Svart tshirt", Description = "Bekväm svart t-shirt, lämplig för alla tillfällen", PriceBeforeVAT = 50, Price = Math.Round(50 * 1.06), IsFoodItem = false, IsDeleted = false, VATId = 2 },
            new Product { Id = 19, Name = "Vit tshirt", Description = "Klassisk vit t-shirt, perfekt för vardagsbruk", PriceBeforeVAT = 50, Price = Math.Round(50 * 1.06), IsFoodItem = false, IsDeleted = false, VATId = 2 }
        );
